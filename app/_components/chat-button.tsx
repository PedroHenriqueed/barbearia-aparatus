...
export function ChatButton() {
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#2E4A35] text-white shadow-lg transition-transform hover:scale-110 active:scale-95"
